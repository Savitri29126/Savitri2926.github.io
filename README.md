...
<h1>📚 Student Time Planner</h1>

<p>Create Daily Study Schedule</p>
...
<option>Fundamentals of Electronics & Communication</option>
...
<button class="add" onclick="addSchedule()">
Add
</button>

<button class="save" onclick="saveSchedule()">
Save
</button>

<button class="display" onclick="displaySchedule()">
Display
</button>
...
<button class="darkbtn" onclick="toggleDarkMode()">
🌙 Dark Mode
</button>
...
showNotification("Schedule Loaded");
